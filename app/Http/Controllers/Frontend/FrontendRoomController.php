...
class FrontendRoomController extends Controller
{
    ...
    public function RoomDetailsPage($id) {
        ...
        return view('frontend.room.room_details', compact('roomDetails', 'multiImage',
         'facility','otherRooms')); 
    } 
    public function BookingSearch(Request $request) {
        ...
        $d_period = CarbonPeriod::create($edate, $alldate); 
        $dt_array = [];
    ...
    public function SearchRoomDetails(Request $request, $id) { 
        ...
        $otherRooms = Room::where('id', '!=', $id)->orderBy('id', 'desc')->limit(2)->get(); 
        $room_id = $id; 
        return view('frontend.room.search_room_details', compact('roomDetails', 'multiImage',
         'facility','otherRooms')); 
    } 
    public function CheckRoomAvailability(Request $request) {
        ...
        $bookings = Booking::withCount('assign_rooms')->whereIn('id',
         $check_date_booking_ids)->where('rooms_id', $room->id)->get()->toArray(); 
