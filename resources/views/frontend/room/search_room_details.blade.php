                        ...
                        <div class="room-details-side">
                            <div class="side-bar-form">
                                ...
                                <form action="{{ route('user_booking_store', $roomDetails->id) }}" method="post" id="bk_form"> 
                                    @csrf 
                                    <input type="hidden" name="room_id" value="{{ $roomDetails->id }} id='room_id' ">
                        ...
                        <div class="room-details-article">
                            <div class="room-details-slider owl-carousel owl-theme"> 
                                ...
                                <div class="room-details-item">
                                    <img src="{{ asset('upload/roomimg/multi_img/'.$item->multi_img) }}" alt="Images">
                                </div> 
                                @endforeach 
                            </div>
...
<script>
    ...
    $("#bk_form").on('submit', function() {
        ...
        if(parseInt(select_room) > av_room){
            alert('Sorry, you select maxinum number of person'); 
            return false; 
        } 
