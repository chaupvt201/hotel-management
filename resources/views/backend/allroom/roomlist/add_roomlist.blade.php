							...
							<div class="card-body p-4">
								...
								<form method="Post" action="{{ route('store.roomlist') }}"class="row g-3"> 
									...
									<div class="col-md-4">
										...
										<input type="email" name="email" class="form-control" id="input5" placeholder="Email" value="{{ old('email') }}">
									</div> 
									<div class="col-md-4">
									...
									<div class="col-md-4">
										...
										<input type="text" name="country" class="form-control" id="input5"  value="{{ old('country') }}">
									</div>  
									<div class="col-md-4">
										<label for="input5" class="form-label">Zip Code</label>
										<input type="text" name="zip_code" class="form-control" id="input5"  value="{{ old('zip_code') }}">
									</div> 
									<div class="col-md-4">
										<label for="input5" class="form-label">State</label>
										<input type="text" name="state" class="form-control" id="input5"  value="{{ old('state') }}">
									</div>
									...
									<div class="col-md-12">
										...
										<textarea name="address" class="form-control" id="input11" rows="3">{{ old('address') }}</textarea>
									</div>
									<div class="col-md-12">
