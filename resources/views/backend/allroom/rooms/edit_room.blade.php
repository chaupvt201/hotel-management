							...
							<div class="card-body p-4">
								...
								<form class="row g-3" action="{{ route('update.room', $editData->id) }}" method="Post" enctype="multipart/form-data"> 
									...
									<div class="col-md-6">
                                        ...
                                        <img id="showImage" src="{{ (!empty($editData->image)) ? url('upload/roomimg/'.$editData->image) : url('upload/no_image.jpg') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="80" >
									</div>
									<div class="col-md-6">
										...
										<img id="showImage" src="{{ (!empty($item->multi_img)) ? url('upload/roomimg/multi_img/'.$item->multi_img) : url('upload/no_image.jpg') }}" alt="Admin" class="bg-primary" width="80" > 
 ...
 <option value="Electronic door lock"  {{$item->facility_name == 'Electronic door lock'?'selected':''}}>Electronic door lock</option> 
    ...
    @empty 
         ...
         <div class="basic_facility_section_remove" id="basic_facility_section_remove">
             <div class="row add_item">
                 <div class="col-md-6">
                     <label for="basic_facility_name" class="form-label">Room Facilities 1 </label>
    ...
    @endforelse
                  ...
                  <br>
									...
									<div class="tab-pane fade" id="primaryprofile" role="tabpanel">
										...
										<input type="text" name="room_no" class="form-control" id="input2" value="">
									</div> 
										...
										<div class="col-md-4">
											<button type="submit" class="btn btn-success" style="margin-top: 28px;">Save</div>
										</div>
													</form> 
                                             </div>
