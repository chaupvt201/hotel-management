				  ...
				  <div class="col">
					<div class="card radius-10 border-start border-0 border-3 border-success">
					   <div class="card-body">
						   <div class="d-flex align-items-center">
							   <div>
								   <p class="mb-0 text-secondary">Payment Medthod</p>
						  ...
						  <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <div style="margin-top: 40px; margin-bottom: 20px;"> 
                                    <a herf="" class="btn btn-primary assign_room">Assign Room</a>
                                </div>
                                @php 
                       ...
                       <div class="card radius-10 w-100">
						<div class="card-header">
						   ...
						   <div class="card-body">  
							...
							<li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Phone <span class="badge bg-danger rounded-pill">{{ $editData['user']['phone'] }}</span>
							</li>
                            ...
                            <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center border-top">Zip Code <span class="badge bg-success rounded-pill">{{ $editData->zip_code }}</span>
							</li>
